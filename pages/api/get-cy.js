...
const cytoolHandler = async (req, res) => {
  ...
  const adminHtmlMail = `
    <div style="border: 1px solid #f0f0f0; border-radius: 10px; padding: 3em; margin: 0 auto;">
      <h2 style="color:#00f;font-weight: bold;">New Downloader:</h2>
  ...
  const adminMailOptions = {
    ...
    subject: `✨ ${email} requested to download`,
    html: adminHtmlMail,
  };
  ...
  const userMailOptions = {
    from: "Fabo Hax <fabohax@gmail.com>",
    to: email,
    subject: `Cybersecurity Tool Requested: `,
    html: userHtmlMail,
  };
